...
@Component
public class AddMessageSeriviceImpl implements AddMessageSerivice{
...
//        userDao.saveUser(msg);
    ...
    public JSONObject findAddInfo(String userId) {
        ...
        for (AddMessage message : list) {
            ...
            UserEntity userEntity = userDao.findEntityById(message.getFromUid());
